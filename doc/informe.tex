...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{cpu.jfif }
		\caption{CPU}
		\label{fig:imagen}
	\end{figure}
...
Para describir adecuadamente un sistema de colas, se deben tener en cuenta las siguientes características fundamentales:
 ...
 \begin{itemize}
 	...
 	\begin{itemize}
 		...
 		\item \textbf{First Come First Served (FCFS)}: El m\'as sencillo de los algoritmos de planificaci\'on que simula una cola sencilla, sin preemptiva ni una prioridad destacada, los procesos son ejecutados en el orden que llegan a al cola de procesos, lo usaremos para realizar comparaciones experimentales posteriormente.
...
\end{itemize}
	...
	Aunque en este proyecto se implementaron y simularon cuatro algoritmos de planificación —uno sin preempción (First-Come First-Served) y tres con preempción (SRTF, Round Robin y MLFQ)—, el análisis detallado se centró exclusivamente en el comportamiento del algoritmo \texttt{SRTF}. Esta elección se debe a su relevancia teórica como algoritmo óptimo en tiempo de espera promedio y a la riqueza de fenómenos que emergen al compararlo con modelos matemáticos clásicos como el \textit{M/M/1} con prioridades dinámicas. Si bien los otros algoritmos también presentan características interesantes, su estudio escapa al alcance del presente estudio experimental.
